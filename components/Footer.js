    ...
    return (
        <footer className='p-4 w-full flex-col items-center'>
            <section className={`flex w-min  ml-auto mr-auto text-color101 dark:text-color100 font-bold pb-2 pt-2`}>
                ...
                <h2 className='p-1 ml-5 mr-5 hover:underline hover:decoration-color12 hover:decoration-double'><a href="https://drive.google.com/file/d/1hKYbERzm9-exkX_LoC51-38S26lEeKpR/view?usp=sharing" target="_blank" rel='noopener noreferrer'>Resume</a></h2>
            </section>
